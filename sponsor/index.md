...
## Why Sponsor OWASP BeNeLux Days 2025?

<a href="{{ site.baseurl }}/assets/files/OWASP_Sponsorship_Brochure_Benelux_2025.pdf" download>Download our sponsor brochure</a>  
...
_**Location:** Lamot Conference Center, Mechelen, Belgium  
**Date:** December 2-3, 2025_
...
| ------------------------------------------------- | --------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- | -------------------------------------------------------- |
| Regular Price                                     | € 4,000                                                                                 | € 3,00                                                                 | € 2,00                                                   |
| Early Bird Offer<br />(by 1st July)               | € 3,600                                                                                 | € 2,700                                                                | € 1,800                                                  |
| Company Logo<br />on OWASP<br />Chapter Homepages | {{site.checkmarkimg}}<br />(Belgium & Netherlands, 2025)                                | {{site.checkmarkimg}}<br />(Belgium & Netherlands, 2025)               | {{site.checkmarkimg}}<br />(Belgium / Netherlands, 2025) |
| Logo on Conference Promotional Materials          | {{site.checkmarkimg}}<br />(Messages, Talks, Schedule)                                  | {{site.checkmarkimg}}<br />(Messages, Talks, Schedule)                 | {{site.checkmarkimg}}<br />(Messages, Talks, Schedule)   |
| Company Banner Near Track Entrance                | {{site.checkmarkimg}}<br />(1m x 2m)                                                    | {{site.checkmarkimg}}<br />(1m x 2m)                                   | -                                                        |
| Name on Chapter Invitations (Meetup and emails)   | {{site.checkmarkimg}}<br />(2025 Invitations)                                           | -                                                                      | -                                                        |
| Name on Posters & Announcements                   | {{site.checkmarkimg}}                                                                   | {{site.checkmarkimg}}                                                  | -                                                        |
| Speaking Slot (\*)                                | {{site.checkmarkimg}}<br />(10 minutes)                                                 | -                                                                      | -                                                        |
| Name in Post-<br />Event Newsletter               | {{site.checkmarkimg}}                                                                   | {{site.checkmarkimg}}                                                  | {{site.checkmarkimg}}                                    |
| Exclusive Add-On Opportunities                    | Social Event (€2,000) - mentioned in the agenda, and rollup during the social event\*\* | Coffee Break (€1,000) mentioned in the agenda, and rollup during break | -                                                        |
| 3-Year Commitment Discount (10%) (\*\*\*)         | {{site.checkmarkimg}}                                                                   | {{site.checkmarkimg}}                                                  | -                                                        |
| First-Pick Booth Placement (\*\*\*\*)             | {{site.checkmarkimg}}                                                                   | {{site.checkmarkimg}}                                                  | -                                                        |

* (\*) The speaking slot will be clearly marked as a sponsor speaking slot at the
start/end of normal talks.
* (\*\*)Social sponsorship at the OWASP Benelux conference entails hosting
...
contact us for more options and details around Social Event Sponsorship.
* (\*\*\*) With a opt-out after first year (without loosing the 10% discount)
* (\*\*\*\*) Order of choice is based on order of commitment and paid sponsorships.
